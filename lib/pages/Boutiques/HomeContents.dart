...
import 'package:galaxie_app/pages/Boutiques/Categories.dart';
import 'package:galaxie_app/pages/Boutiques/SwipperViewProd.dart';
import 'package:galaxie_app/pages/Produits/SingleProduit.dart';
import 'package:galaxie_app/utility/TitrePage.dart';
 

class AllProdScreen extends StatefulWidget {
  const AllProdScreen({Key? key}) : super(key: key);

  @override
  _AllProdScreenState createState() => _AllProdScreenState();
}
