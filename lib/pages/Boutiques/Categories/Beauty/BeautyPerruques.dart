...
class BeautyPerruquesScreen extends StatefulWidget {
  const BeautyPerruquesScreen({super.key});

  @override
  State<BeautyPerruquesScreen> createState() => _BeautyPerruquesScreenState();
}

class _BeautyPerruquesScreenState extends State<BeautyPerruquesScreen> {
    ...
    return Container(
      ...
      child: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance
          ...
          .where('sousCategories', isEqualTo: 'Perruque')
          .snapshots(),
