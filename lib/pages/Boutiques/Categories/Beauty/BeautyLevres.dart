...
class BeautyLevresScreen extends StatefulWidget {
  const BeautyLevresScreen({super.key});

  @override
  State<BeautyLevresScreen> createState() => _BeautyLevresScreenState();
}

class _BeautyLevresScreenState extends State<BeautyLevresScreen> {
    ...
    return Container(
      ...
      child: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance
          ...
          .where('sousCategories', isEqualTo: 'Yeux')
          .snapshots(),
