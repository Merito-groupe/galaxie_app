...
class BeautyYeuxScreen extends StatefulWidget {
  const BeautyYeuxScreen({super.key});

  @override
  State<BeautyYeuxScreen> createState() => _BeautyYeuxScreenState();
}

class _BeautyYeuxScreenState extends State<BeautyYeuxScreen> {
