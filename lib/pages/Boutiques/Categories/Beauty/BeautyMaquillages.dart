...
class BeautyMaquillagesScreen extends StatefulWidget {
  const BeautyMaquillagesScreen({super.key});

  @override
  State<BeautyMaquillagesScreen> createState() => _BeautyMaquillagesScreenState();
}

class _BeautyMaquillagesScreenState extends State<BeautyMaquillagesScreen> {
    ...
    return Container(
      ...
      child: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance
          ...
          .where('sousCategories', isEqualTo: 'Maquillage')
          .snapshots(),
