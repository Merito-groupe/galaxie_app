...
class ChauAutresChaussuresHommeScreen extends StatefulWidget {
  const ChauAutresChaussuresHommeScreen({super.key});

  @override
  State<ChauAutresChaussuresHommeScreen> createState() =>
      _ChauAutresChaussuresHommeScreenState();
}

class _ChauAutresChaussuresHommeScreenState
    extends State<ChauAutresChaussuresHommeScreen> {
