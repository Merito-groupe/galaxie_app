...
class SportCyclisme extends StatefulWidget {
  const SportCyclisme({super.key});

  @override
  State<SportCyclisme> createState() => _SportCyclismeState();
}

class _SportCyclismeState extends State<SportCyclisme> {
  @override
    ...
    return Container(
      ...
      child: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance
          ...
          .where('sousCategories', isEqualTo: 'Cyclisme')
          .snapshots(),
